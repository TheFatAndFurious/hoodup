...
func InitializeSchema(db *sql.DB) error {
	statements := []string{
		...
		"CREATE TABLE IF NOT EXISTS articles (id INTEGER PRIMARY KEY AUTOINCREMENT, title TEXT, content TEXT, exerpt TEXT, published BOOLEAN, published_at DATETIME, author INTEGER, FOREIGN KEY (author) REFERENCES users(id))",
